...
export default function BookingSummary({ car, totalDays, totalPrice }) {
    ...
    >
      ...
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-center">
          ...
          <span className="font-semibold text-right">{car.name}</span>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-green-400 font-semibold">Ready to Book</span>
        </div>
